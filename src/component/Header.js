        ...
        <div className="with-vertical">
          ...
          <nav className="navbar navbar-expand-lg p-0">
            ...
            <ul className="navbar-nav quick-links d-none d-lg-flex align-items-center">
              ...
              <li className="nav-item dropdown-hover d-none d-lg-block">
                <a className="nav-link" href="../dark/app-calendar.html">
                  Calendar
                </a>
              </li>
              <li className="nav-item dropdown-hover d-none d-lg-block">
                <a className="nav-link" href="../dark/app-email.html">
                  Email
                </a>
              </li>
            </ul>
                        ...
                        <div className="message-body">
                          ...
                          >
                            <span className="d-flex align-items-center justify-content-center text-bg-light rounded-1 p-6">
                              <img
                                src="../../assets/assets/images/svgs/icon-account.svg"
                                alt="modernize-img"
                                width={24}
                                height={24}
                              />
                            ...
                            <div className="row">
                              ...
                              <div className="col-6">
                                <div className="m-n4 unlimited-img">
                                  <img
                                    src="../../assets/assets/images/backgrounds/unlimited-bg.png"
                                    alt="modernize-img"
                                    className="w-100"
                                  />
                                </div>
